...
class Solution {
    ...
    private void traverse(Vertex u, int powerGridId, PriorityQueue<Integer> powerGrid, Graph graph) {
        ...
        for (int[] q : queries) {
            ...
            if (op == 1) {
                ...
                if (!vertex.offline) {
                    ...
                    PriorityQueue<Integer> powerGrid = powerGrids.get(vertex.powerGridId);
